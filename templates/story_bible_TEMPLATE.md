...
[ONE SENTENCE SUMMARY OF THE ENTIRE STORY - who is the protagonist, what is their central conflict, what is at stake, and how do they change]
...
#### Physical World
[Describe the primary and secondary locations. What does the reader see, hear, smell? What makes these places distinctive? Be specific enough that another writer could set scenes here.]

#### Social / Cultural Context
[What social dynamics, cultural tensions, or community structures shape the world? Who holds power, who is marginalized, what subcultures exist?]

#### Rules & Constraints
- [Rule 1 - e.g. This is a realistic contemporary story with no magical elements]
- [Rule 2 - e.g. Technology functions as it does in real life]
- [Rule 3 - e.g. Character growth follows realistic trajectories]
- [Rule 4]
...
- **Role:** Protagonist
- **Age:** [AGE]
- **Description:** [Physical appearance, what they wear, how they carry themselves, distinguishing features]

- **Voice:** [How do they speak? Internal monologue style? Accent? Vocabulary range? What topics make them open up vs. shut down?]

- **Goals:** [What do they want consciously? What do they need unconsciously? How do these conflict?]

- **Secrets:** [What do they hide from others? From themselves? What would happen if it came out?]
...
- **Age:** [AGE]
- **Description:** [Physical appearance and bearing]

- **Voice:** [Speech patterns, vocabulary, what makes them distinctive]

- **Goals:** [What do they want? How does this align or conflict with the protagonist?]
...
#### What to Avoid
- [e.g. Sentimental portrayals of easy success]
- [e.g. Cartoonish villains whose motivations are one-dimensional]
- [e.g. Convenient coincidences that resolve plot problems]
- [Avoid X, Y, Z]
...
**Act 2 (Chapters [X]-[Y]): [Act 2 Name]**
[What complications arise? How does the protagonist struggle against the central conflict? What is the midpoint turning point? How do things fall apart before they can come together?]

**Act 3 (Chapters [Y]-[Z]): [Act 3 Name]**
[How does the protagonist confront the central conflict? What is the climax? How does the protagonist change? How are the themes resolved — or left open?]
...
| Event | Description |
|-------|-------------|
| [YEAR/AGE] | [Event description - keep to major beats only] |
| [YEAR/AGE] | [Event description] |
| [YEAR/AGE] | [Event description] |
| [YEAR/AGE] | [Story begins here] |
| [YEAR/AGE] | [Story ends here] |
...
3. **Chapter 3 — [TITLE]** — [1-2 sentence summary] → ends: [Hook or cliffhanger ending]
